# SentencePiece-based configuration with explicit train/val split (v5).
name = "modelB-v5"
...
n_embd = 320  # the number of embedding dimensions
n_head = 10  # the number of attention heads
